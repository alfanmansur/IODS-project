...
Second, we synthesize information from the Normal Q-Q plot (see the second figure below). Our intention here is to check whether the Normality holds since we assume that the error terms are Normally distributed or $\varepsilon \sim N(0,\sigma^2)$. From the plot, there is an indication that the errors slightly deviates from the Normal distribution as not all dots fall into the straight line curve. However, they look still acceptable.
