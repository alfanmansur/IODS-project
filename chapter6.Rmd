...
```
\
In the RATS dataset, there are three kind of treatments that can bee seen from the plot above as group 1, group 2, and group three. The weight (in grams) of the rats is on y-axes plotted against time (in days) on x-axes.
\
